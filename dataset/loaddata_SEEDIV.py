...
def load_SEEDIV():
    ...
    train_data_final = np.concatenate((train_data1, train_data2, train_data3))
    train_label_final = np.concatenate((train_labels1, train_labels2, train_labels3))
    test_data_final = np.concatenate((test_data1, test_data2, test_data3))
    test_label_final = np.concatenate((test_labels1, test_labels2, test_labels3))
    # train_data_final = torch.Tensor(train_data_final)
    # train_label_final = torch.LongTensor(train_label_final)
    # test_data_final = torch.Tensor(test_data_final)
    # test_label_final = torch.LongTensor(test_label_final)
    # train_dataset = TensorDataset(train_data_final, train_label_final)
    # test_dataset = TensorDataset(test_data_final, test_label_final)
...
if __name__ == '__main__':
    ...
    # sio.savemat(result_dir + "SEED-IV",
    #             {"train_data": train_data_final, "train_labels": train_label_final, "test_data": test_data_final,
