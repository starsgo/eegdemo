    ...
    def __init__(
        ...
        **kwargs
        ...
        self.transformer = Block(
                dim=emb_size, num_heads=heads, mlp_ratio=4, qkv_bias=None, qk_norm=None,
                qk_scale=None,
...
class BIOTClassifier(nn.Module):
    def __init__(self, emb_size=256, heads=8, depth=4, n_classes=4, **kwargs):
        super().__init__()
        self.biot = BIOTEncoder(emb_size=emb_size, heads=heads, depth=depth, n_channels=62,**kwargs)
...
if __name__ == "__main__":
    ...
    model = BIOTClassifier(n_fft=200, hop_length=200, depth=4, heads=8, n_classes=4)
    out = model(x)
    print(out.shape)
